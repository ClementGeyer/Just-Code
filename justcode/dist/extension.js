...
exports.insertInlineCommentCommand = void 0;
const vscode = __webpack_require__(1);
const api_1 = __webpack_require__(4);
const insertInlineCommentCommand = () => {
    vscode.window.withProgress({
        ...
        if (selection && !selection.isEmpty) {
            ...
            let data = yield (0, api_1.generateComment)(highlighted);
            console.log(data);
...
exports.insertInlineCommentCommand = insertInlineCommentCommand;
...
const axios_retry_1 = __webpack_require__(45);
...
// accessToken: string
    ...
    try {
        ...
        (0, axios_retry_1.default)(axios_1.default, { retryDelay: axios_retry_1.default.exponentialDelay, retries: 5 });
        vscode.window.showErrorMessage("Error: Something went wrong. Try again shortly.");
        console.log(err);
        if (err.request.data) {
...
const axiosRetry = (__webpack_require__(46)["default"]);
...
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(51));

var _defineProperty2 = _interopRequireDefault(__webpack_require__(52));

var _isRetryAllowed = _interopRequireDefault(__webpack_require__(55));
...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand("justcode.helloWorld", commands_1.insertInlineCommentCommand);
